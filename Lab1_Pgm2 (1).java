...
*/
		...
		System.out.print("Enter the row & column size of the 1st Matrix : ");
		int row1 = Integer.parseInt(sc.next());
		int col1 = Integer.parseInt(sc.next());
		
		System.out.print("\nEnter the row & column size of the 2nd Matrix : ");
		...
		if((row1 == row2) && (col1 == col2))
		{
			...
			System.out.println("\nEnter the values of the 1st Matrix : ");
			...
			System.out.println("\nEnter the values of the 2nd Matrix : ");
