class CPU
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Program   : Create CPU with attribute price. Create inner class Processor (no. of cores, manufacturer) and static nested \nclass RAM (memory, manufacturer). Create an object of CPU and print information of Processor and RAM.");
		System.out.println("****************************************************************************************************************************");
